...
BASECONFIGFILE=${MACH3_DIR}/$BUILD_DIR/configs/p7_2024a_ND_MultiChainBase_GUNDAMlike.yaml

# Output

OUTPUT_FILE=MaCh3_OAR11B_v12_Data_MCMC_GUNDAMlike_${SLURM_ARRAY_TASK_ID}.root
...
export MACH3_MC=/home/dlangrid/scratch/Splines/Prod7E/v12_Highland_3.22.4/MC_mirrored/

JOB_CONFIG=tempConfig_MCMC_Data_GUNDAMlike_${SLURM_ARRAY_TASK_ID}.yaml
